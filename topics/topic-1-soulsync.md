...
Riley is your stakeholder, not your spec. Your job is not to ship Riley's vision — that is impossible. Your job is to identify the kernel of a good idea, ship a defensible thin slice, and write `PLAN.md` explaining what you cut, what you'd cut even with a year, and what you're proposing instead.
